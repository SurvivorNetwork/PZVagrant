...
if ! id -u steam >/dev/null 2>&1; then
	echo "[PZV-Provision] Creating user 'steam'..."
    useradd -m steam
fi
...
if [[ "$(wget --tries=3 --timeout=5 --spider http://google.com 2>&1 | grep 'connected')" ]]; then
	...
	dpkg --add-architecture i386 #for lgsm - also steamcmd lib32gcc1 dep(?) TODO: Add configurable VM architecture/box
	...
	apt_package_check_list=(
		...
		openjdk-7-jre
		sqlite3
		adminer   #TODO: review http://sourceforge.net/p/adminer/discussion/960418/thread/875bbe24/ to get this working with nginx
		nodejs
	#lgsm deps
		#tmux
		#mailutils
...
#TODO: Open these ports, and those from Vagrantfile: https://wiki.debian.org/iptables
